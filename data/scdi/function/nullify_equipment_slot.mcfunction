# called with {equip_key:"head/chest/legs/feet",slot_arg:"armor.head/...",orig:"minecraft:..."}
# once check_custom_item_equipment_slot(.mcfunction) confirms it's needed.
# hands off to apply_nullify_equipment_slot.mcfunction (the armor-stand
# relay technique) rather than apply_nullify_hotbar_slot - see that file
# for why armor slots can't use the same /item modify approach genuine
# hotbar slots do.
...
function scdi:apply_nullify_equipment_slot with storage scdi:tmp
