...
tellraw @s [{"text":"    > ","color":"dark_gray"},{"text":"Disguise Appearance 2","color":"aqua","underlined":true,"click_event":{"action":"run_command","command":"/function scdi:menu/disguise2"},"hover_event":{"action":"show_text","value":"Skips straight to page 2: armor flash particles/colors, optional recolor, equip sound, and the player-facing disabled-item warnings."}},{"text":"  - flash, recolor, warnings","color":"dark_gray"}]
...
tellraw @s [{"text":"    > ","color":"dark_gray"},{"text":"Detection & Tagging 2","color":"aqua","underlined":true,"click_event":{"action":"run_command","command":"/function scdi:menu/detection2"}},{"text":"  - skips straight to page 2: tagging rules, team hits, one-shot link","color":"dark_gray"}]
...
tellraw @s [{"text":"    > ","color":"dark_gray"},{"text":"Misc 2","color":"aqua","underlined":true,"click_event":{"action":"run_command","command":"/function scdi:menu/misc2"},"hover_event":{"action":"show_text","value":"Skips straight to page 2: dummy announcements, health display, passive regen, health pool tuning, and the teleport command used for tracking."}},{"text":"  - announcements, regen, health","color":"dark_gray"}]
