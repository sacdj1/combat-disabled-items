...
#
# Curse of Binding was tried here too but removed - see
# apply_nullify_armor.mcfunction for why (the restore path needs to
# correctly revert appearance regardless of item location, not just block
