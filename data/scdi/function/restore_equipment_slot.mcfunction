...
$execute if data entity @s equipment.$(equip_key).components."minecraft:fireworks" run data modify storage scdi:tmp fireworks set from entity @s equipment.$(equip_key).components."minecraft:fireworks"
